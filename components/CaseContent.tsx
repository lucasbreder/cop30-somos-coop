...
export const CaseContent = ({data}: {data: CaseData}) => {
    ...
    return (
         <div className={`w-full h-4/6 z-20 rounded-2xl p-10 transition-all duration-700 ease-in-out left-0 relative border border-white/20 mt-20`}>
    ...
    >
       <motion.div 
            ...
            style={{y}}
            className="bg-white h-15 w-3 rounded-2xl cursor-grab mt-1" 
        />
    </div>}
