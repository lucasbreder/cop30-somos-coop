...
export const AnimatedIntro = ({ duration = 2, width, height, strokeColor = "var(--secondary)", strokeWidth = 3, delay = 0 }: 
    {duration?: number, width:number | string, height:number | string, strokeColor?: string, strokeWidth?:number, delay?:number}) => {
