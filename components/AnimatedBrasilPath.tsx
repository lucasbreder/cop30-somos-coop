...
export const AnimatedBrasilPath = ({
  duration = 2,
  width,
  height,
  strokeColor1 = "var(--sextenary)",
  strokeColor2 = "var(--tertiary)",
  strokeColor3 = "var(--quaternary)",
  strokeWidth = 3,
  reverse = false,
}: {
  duration?: number;
  ...
  return (
    <svg width={width} height={height} viewBox="0 0 723.77 1175.8599">
      ...
      />
      <g transform="translate(248.34574,769.46296)">
        <motion.path
          fill="transparent"
          strokeLinecap="round"
          initial={{ pathLength: 0 }}
      ...
      <g transform="translate(213.85679,759.90555)">
        <motion.path
          fill="transparent"
          strokeLinecap="round"
          initial={{ pathLength: 0 }}
