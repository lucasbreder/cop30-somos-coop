...
const getFixedImagePath = (index: number) =>
  `/intro/intro-pic${(index % 14) + 1}.png`; // 1 a 14, repetindo
const getFixedGalleryPath1 = (index: number) =>
  `/intro/intro-pic${((index + 6) % 14) + 1}.png`;
const getFixedGalleryPath2 = (index: number) =>
  `/intro/intro-pic${((index + 12) % 14) + 1}.png`;
...
export const casesPt: Case[] = [
  {
    ...
    excerpt:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur id libero at nunc euismod pretium nec sed quam. Suspendisse eget efficitur quam.",
    challenge:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur id libero at nunc euismod pretium nec sed quam. Suspendisse eget efficitur quam.",
    development:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur id libero at nunc euismod pretium nec sed quam. Suspendisse eget efficitur quam.",
  ...
  },
  {
    ...
    gallery: [
      "/intro/intro-pic4.png",
      "/intro/intro-pic1.png",
      "/intro/intro-pic6.png",
      "/intro/intro-pic2.png",
      "/intro/intro-pic1.png",
      "/intro/intro-pic3.png",
    ],
  },
  {
    id: 27,
